...
@implementation UIApplicationDelegate {
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_1 (self, _cmd, &managed_method, &call_super, 0x10E04);
		if (call_super && rv) {
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, 0x8A04);
	}
	-(BOOL) conformsToProtocol: (void *) protocol
	{
		GCHandle exception_gchandle;
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		{ NULL, 0xF04 /* #0 'NSObject' => 'Foundation.NSObject, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2A04 /* #1 'UIApplicationDelegate' => 'UIKit.UIApplicationDelegate, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x300 /* #2 'AppDelegate' => 'WebView.AppDelegate, WebKit_sample1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2B04 /* #3 'UIResponder' => 'UIKit.UIResponder, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2804 /* #4 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x400 /* #5 'ViewController' => 'WebView.ViewController, WebKit_sample1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2704 /* #6 'UIView' => 'UIKit.UIView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x604 /* #7 'WKWebView' => 'WebKit.WKWebView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x704 /* #8 'WKNavigation' => 'WebKit.WKNavigation, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x804 /* #9 'WKWebViewConfiguration' => 'WebKit.WKWebViewConfiguration, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xD04 /* #10 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xE04 /* #11 'NSURLRequest' => 'Foundation.NSUrlRequest, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1504 /* #12 'NSProxy' => 'Foundation.NSProxy, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1604 /* #13 'NSURL' => 'Foundation.NSUrl, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1B04 /* #14 'NSException' => 'Foundation.NSException, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2504 /* #15 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2904 /* #16 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x1304 /* #17 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0 },
	};

	static const MTAssembly __xamarin_registration_assemblies [] = {
		{ "WebKit_sample1", "cb939c2f-f677-4abd-831d-91ef766f8045" }, 
		{ "mscorlib", "aae03b95-719e-488f-8a16-3bae4d2b5dcb" }, 
		{ "Xamarin.iOS", "41c5142e-3a67-4776-b1d1-1b5296447e98" }, 
		{ "System", "ee6a1987-eb2f-48bd-b8b5-f0cf4659dd86" }
	};

	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		{ 0x1C04 /* Foundation.INSObjectProtocol */, 0x1D04 /* NSObjectProtocolWrapper */ },
	};
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [12].handle = objc_getClass ("NSProxy");
	__xamarin_class_map [13].handle = objc_getClass ("NSURL");
	__xamarin_class_map [14].handle = objc_getClass ("NSException");
	__xamarin_class_map [15].handle = objc_getClass ("UIApplication");
	__xamarin_class_map [16].handle = objc_getClass ("UIWindow");
	__xamarin_class_map [17].handle = objc_getClass ("__NSObject_Disposer");
